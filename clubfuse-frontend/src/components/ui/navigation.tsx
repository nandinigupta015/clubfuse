                ...
                {publicLinks.map((l) => (
                  ...
                  >
                    ...
                    {isActive(l.path) && (
                      <motion.div
                        layoutId="activeTab"
                        className="absolute -bottom-[21px] left-0 right-0 h-0.5 bg-purple-600 rounded-full"
                    ...
                    <AnimatePresence>
                      {unreadCount > 0 && (
                        <motion.span
                          ...
                          animate={{ scale: 1 }}
                          exit={{ scale: 0 }}
                          className="absolute top-1 right-1 bg-red-500 text-white text-[10px] font-bold rounded-full w-4 h-4 flex items-center justify-center ring-2 ring-white"
                        >
                  ...
                  <AnimatePresence>
                    {bellOpen && (
                      <motion.div
                        ...
                        className="absolute right-0 mt-3 w-85 bg-white/90 backdrop-blur-2xl border border-white/20 rounded-3xl shadow-2xl z-50 overflow-hidden ring-1 ring-black/5"
                      >
                        {/* Header */}
